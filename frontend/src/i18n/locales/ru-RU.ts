...
export default {
  ...
  maintenance: {
    ...
    inventory: maintenanceInventoryLocales['ru-RU'],
    ...
    scenario: {
      eyebrow: 'Рабочая область сценария миссии',
      title: 'Мастер сценария',
      newTitle: 'Сценарий миссии без названия',
      description: 'Подтвердите границы миссии, конфигурацию, этапы и политику расчёта с источником, уверенностью и риском для каждого поля.',
      stepsLabel: 'Этапы сценария',
      complete: 'Готово',
      incomplete: 'Не завершено',
      confirmed: 'Подтверждено',
      loading: 'Загрузка черновика сценария…',
      selectPlaceholder: 'Выберите значение',
      unsavedLeave: 'Есть несохранённые локальные изменения. Покинуть страницу?',
      steps: {
        basics: 'Основа миссии',
        configuration: 'Конфигурация парка',
        mission: 'Профиль миссии',
        reliabilityRepair: 'Надёжность и ремонт',
        calculation: 'Политика расчёта',
        confirmation: 'Контроль выпуска',
      },
      stepHints: {
        basics: 'Задайте идентификатор, временное окно и приоритет миссии.',
        configuration: 'Выберите опубликованную конфигурацию и участвующий парк.',
        mission: 'Разбейте миссию на проверяемые этапы и укажите активное количество.',
        reliabilityRepair: 'Подтвердите данные надёжности и ремонта; выводы ИИ требуют принятия человеком.',
        calculation: 'Задайте уровень сервиса, режим выполнения и политику отсутствующих параметров.',
        confirmation: 'Проверьте блокировки и происхождение полей перед созданием DRAFT.',
      },
      fields: {
        ...
        activeQuantity: 'Активное количество',
        maintenanceLevel: 'Уровень обслуживания',
        reliabilityProfiles: 'Профили надёжности',
        repairPolicy: 'Политика ремонта',
        shockPolicy: 'Политика общих воздействий',
        serviceLevel: 'Уровень сервиса',
        executionMode: 'Режим выполнения',
        missingPolicy: 'Политика отсутствующих параметров',
      },
      sources: {
        MASTER_DATA: 'Основные данные',
        USER_INPUT: 'Ввод пользователя',
        AI_INFERRED: 'Вывод ИИ',
        SYSTEM_DEFAULT: 'Системное значение',
      ...
      actions: {
        previous: 'Назад',
        next: 'Далее',
        confirm: 'Подтвердить значение',
        evidence: 'источников',
        applyFleet: 'Применить парк',
        reloadServer: 'Загрузить версию сервера',
        discardLocal: 'Отменить локальные изменения',
        materialize: 'Создать версию DRAFT',
        materializing: 'Создание…',
      },
      conflict: {
        title: 'Черновик на сервере изменён',
        description: 'Локальный черновик сохранён. Сравните версии, затем загрузите серверную или явно отмените локальные изменения.',
        local: 'Локальные изменения',
        server: 'Версия сервера',
      },
      confirmation: {
        completedSteps: 'Завершённые этапы',
        blockingCount: 'Блокирующие поля',
        draftVersion: 'Версия черновика',
        aiReview: 'Выводы, ожидающие проверки',
        blocked: 'Создание версии заблокировано',
        ready: 'Все предварительные проверки выполнены',
        readyHint: 'Будет создан только редактируемый DRAFT. Для публикации требуется повторное подтверждение администратора.',
      },
      materialization: {
        draftCreated: 'Версия DRAFT создана',
        failed: 'Не удалось создать версию',
      },
      list: {
        description: 'Просматривайте сценарии, статусы версий и последние изменения, затем открывайте сведения о версии.',
        refresh: 'Обновить',
        create: 'Новый сценарий',
        search: 'Поиск сценариев',
        searchPlaceholder: 'Введите код или название',
        apply: 'Найти',
        includeInactive: 'Показывать неактивные сценарии',
        records: 'записей',
        emptyTitle: 'Сценариев пока нет',
        emptyDescription: 'Создайте первый сценарий миссии или измените фильтры.',
        code: 'Код сценария',
      ...
      detail: {
        back: 'К списку сценариев',
        invalid: 'Некорректная ссылка на сценарий',
        lifecycle: 'Жизненный цикл',
        active: 'Активен',
        inactive: 'Неактивен',
        versions: 'Реестр версий',
        ...
        stages: 'Этапы миссии',
        fleets: 'Группы техники',
        overrides: 'Переопределения параметров',
        selectVersion: 'Выберите версию',
        selectVersionHint: 'Откройте полный снимок в реестре версий. Опубликованные версии доступны только для чтения.',
        publishConfirmTitle: 'Опубликовать эту версию?',
        publishConfirmBody: 'Версия станет официальным входом для расчётов. Подтвердите завершение проверки.',
        publishSuccess: 'Версия опубликована',
        retireConfirmTitle: 'Вывести эту версию из эксплуатации?',
        retireConfirmBody: 'Версия не будет использоваться в новых расчётах, но история сохранится.',
        retireSuccess: 'Версия выведена из эксплуатации',
      },
      adminPublication: {
        title: 'Публикация администратором',
        description: 'Только администратор может опубликовать DRAFT как PUBLISHED.',
      },
      empty: {
        fleetFirst: 'Сначала выберите конфигурацию и создайте парк.',
        reliability: 'Нет доступных профилей надёжности. Сначала добавьте основные данные.',
      },
      errors: {
        masterData: 'Не удалось загрузить основные данные. Повторите попытку.',
        draftLoad: 'Не удалось загрузить черновик сценария.',
        materialize: 'Не удалось создать версию DRAFT.',
      },
    },
  },
  chatHeader: {
