...
export default {
  ...
  maintenance: {
    ...
    reports: {
      ...
      actions: { apply: 'Apply', clear: 'Clear', retry: 'Retry', previous: 'Previous', next: 'Next', cancel: 'Cancel', create: 'Create report', view: 'Open', generate: 'Generate', validate: 'Validate', finalize: 'Finalize', regenerate: 'Regenerate', export: 'Export' },
      createDialog: { title: 'Create report', titleLabel: 'Title', typeLabel: 'Report type', selectType: 'Select a report type', sources: 'Authoritative source references', selectSourceType: 'Select a source type', sourceId: 'Source ID', sourceVersion: 'Source version', addSource: 'Add source reference', legacy: 'Legacy compatibility IDs (optional)', invalid: 'Enter a title, report type, and at least one valid source reference.' },
      regenerate: { title: 'Regenerate report', explanation: 'A new version is created, its source snapshot is copied from the current report version, and no business source data is recalculated.' },
      errors: { versionAlreadyGenerated: 'This report version has already been generated.', generationRequired: 'Generate the report before continuing.', finalVersionImmutable: 'Final report versions are immutable.', regenerateSourceNotReady: 'The current report version is not ready to regenerate.', validationRequired: 'Validation is required before continuing.', generationFailed: 'Report generation failed.', sourceRequired: 'At least one valid source reference is required.', sourceConflict: 'The report source conflicts with current data.', sourceVersionConflict: 'The report source version is no longer current.', insufficientRole: 'Your role cannot perform this report action.', generic: 'The report action could not be completed.', requestId: 'Request ID: {requestId}' },
    },
    pages: {
      dashboard: 'Dashboard',
    ...
    review: {
      eyebrow: 'Authoritative demand review',
      list: {
        title: 'Demand list reviews',
        description: 'Track formal review status, blockers and pending findings, and start deterministic review from the current published demand list.',
        register: 'Review register',
        total: '{count} reviews',
        loading: 'Loading formal reviews…',
        empty: 'No formal demand reviews yet.',
        id: 'Review ID',
        source: 'Source list',
        updated: 'Updated',
        actions: 'Actions',
      ...
      source: {
        ...
        description: 'Sources come only from server-returned current PUBLISHED demand lists; the browser submits only source identity and expected version.',
        currentPublished: 'Current published demand list',
        select: 'Select a current published list',
        status: 'Status',
      ...
      summary: {
        ...
        pending: 'Pending findings',
        pendingBlocking: 'Pending blocking findings',
      },
      finding: {
        title: 'Review findings',
        description: 'Filter, select and decide formal findings; batch decisions are validated atomically by the server.',
        all: 'All',
        key: 'Finding key',
        rule: 'Rule',
        severity: 'Severity',
        ...
        nonBlockingOnly: 'Non-blocking only',
        admin: 'Admin acceptance required',
      ...
      decision: {
        ...
        reason: 'Reason',
        highRisk: 'Accepting or edit-accepting this finding is high risk and requires administrator capability.',
      },
      validation: {
        adminRequired: 'Your current permissions do not allow high-risk acceptance.',
        reasonRequired: 'EDIT_ACCEPTED requires a non-empty reason.',
        positiveQuantity: 'EDIT_ACCEPTED final quantity must be a number greater than 0.',
      },
      detail: {
        title: 'Review #{id}',
        loadingTitle: 'Loading review',
        loading: 'Loading formal review detail…',
        invalidRoute: 'Invalid review link.',
        source: 'Source demand list',
        ruleSet: 'Rule-set version',
        version: 'Review version',
      },
      conflict: {
        title: 'The review has a version conflict',
        expected: 'Expected version',
        actual: 'Actual version',
        suggested: 'Suggested action',
        reloadHint: 'Reload server state and reconfirm the decision.',
        reload: 'Reload server state',
      },
      derive: {
        title: 'Derive a new demand-list DRAFT',
        description: 'Available only after all blocking findings have final decisions and the user has finalizeReview permission.',
        confirmation: 'Derive a new demand-list DRAFT from the accepted formal review decisions?',
      },
      actions: {
        refresh: 'Refresh',
        run: 'Run formal review',
        running: 'Running…',
        open: 'Open',
        back: 'Back to reviews',
        decide: 'Decide',
        batchDecide: 'Batch decide ({count})',
    ...
    scenario: {
      eyebrow: 'Mission scenario workspace',
      title: 'Scenario wizard',
      newTitle: 'Untitled mission scenario',
      description: 'Confirm mission boundaries, configuration, stages and calculation policy with a traceable source, confidence and risk for every field.',
      stepsLabel: 'Scenario steps',
      complete: 'Complete',
      incomplete: 'Incomplete',
      confirmed: 'Confirmed',
      loading: 'Loading scenario draft…',
      selectPlaceholder: 'Select an option',
      unsavedLeave: 'Local changes are still unsaved. Leave this page?',
      steps: {
        basics: 'Mission basis',
        configuration: 'Fleet configuration',
        mission: 'Mission profile',
        reliabilityRepair: 'Reliability & repair',
        calculation: 'Calculation policy',
        confirmation: 'Release gate',
      },
      stepHints: {
        basics: 'Define the mission identity, time window and priority that bound every downstream calculation.',
        configuration: 'Choose a published configuration and define the participating fleet without importing inactive master data.',
        mission: 'Break the mission into auditable stages and assign active quantity and operating intensity.',
        reliabilityRepair: 'Confirm reliability evidence and repair policy; AI-inferred values require human acceptance.',
        calculation: 'Set the service level, execution mode and missing-parameter policy.',
        confirmation: 'Review blockers and field provenance before creating a DRAFT version.',
      },
      fields: {
        ...
        shockPolicy: 'Common-shock policy',
      ...
      actions: {
        ...
        applyFleet: 'Apply fleet',
        reloadServer: 'Reload server version',
        discardLocal: 'Discard local changes',
        materialize: 'Create DRAFT version',
        materializing: 'Creating…',
      },
      conflict: {
        title: 'The server draft has changed',
        description: 'Your local draft remains intact. Compare both versions, then reload or explicitly discard local changes.',
        local: 'Local changes',
        server: 'Server version',
      },
      confirmation: {
        completedSteps: 'Completed steps',
        blockingCount: 'Blocking fields',
        draftVersion: 'Draft version',
        aiReview: 'Inferred values awaiting review',
        blocked: 'Version creation is blocked',
        ready: 'All pre-release checks are satisfied',
        readyHint: 'This creates an editable DRAFT only. Publication still requires secondary admin confirmation.',
      },
      materialization: {
      ...
      list: {
        description: 'Browse scenario records, version status and recent activity, then open a version dossier.',
        refresh: 'Refresh',
        create: 'New scenario',
        search: 'Search scenarios',
        searchPlaceholder: 'Enter a code or name',
        apply: 'Apply',
        includeInactive: 'Include inactive scenarios',
        records: 'records',
        emptyTitle: 'No scenarios yet',
        emptyDescription: 'Create the first mission scenario or adjust the current filters.',
        code: 'Scenario code',
        name: 'Scenario name',
        category: 'Category',
      ...
      detail: {
        ...
        invalid: 'Invalid scenario link',
        lifecycle: 'Lifecycle',
        active: 'Active',
        inactive: 'Inactive',
        versions: 'Version register',
        ...
        selectVersionHint: 'Open a complete snapshot from the version register. Published versions remain read-only.',
        publishConfirmTitle: 'Publish this version?',
        publishConfirmBody: 'This version will become an official calculation input. Confirm that review is complete.',
        publishSuccess: 'Version published',
        retireConfirmTitle: 'Retire this version?',
        retireConfirmBody: 'The version will no longer be used for new calculations. Historical records remain available.',
        retireSuccess: 'Version retired',
      },
      adminPublication: {
        title: 'Admin publication',
        description: 'Only an administrator can publish a DRAFT as PUBLISHED.',
      },
      empty: {
        fleetFirst: 'Choose a configuration and create a fleet before assigning stage usage.',
        reliability: 'No reliability profiles are available. Add master data first.',
      },
      errors: {
        masterData: 'Master data could not be loaded. Try again.',
        draftLoad: 'The scenario draft could not be loaded.',
        materialize: 'The DRAFT version could not be created.',
      },
    },
  },
  chatHeader: {
