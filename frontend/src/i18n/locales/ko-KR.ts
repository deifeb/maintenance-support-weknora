export default {
  ...
  maintenance: {
    ...
    scenario: {
      eyebrow: "임무 시나리오 작업공간",
      title: "시나리오 마법사",
      newTitle: "이름 없는 임무 시나리오",
      description: "각 필드의 출처, 신뢰도와 위험을 기록하며 임무 범위, 구성, 단계와 계산 정책을 확인합니다.",
      stepsLabel: "시나리오 단계",
      complete: "완료",
      incomplete: "미완료",
      confirmed: "확인됨",
      loading: "시나리오 초안을 불러오는 중…",
      selectPlaceholder: "선택하세요",
      unsavedLeave: "저장되지 않은 로컬 변경이 있습니다. 페이지를 나갈까요?",
      steps: {
        basics: "임무 기본",
        configuration: "장비 구성",
        mission: "임무 프로파일",
        reliabilityRepair: "신뢰성 및 수리",
        calculation: "계산 정책",
        confirmation: "릴리스 확인",
      },
      stepHints: {
        basics: "후속 계산의 경계가 되는 임무 식별자, 기간과 우선순위를 정의합니다.",
        configuration: "게시된 구성과 참여 장비군을 선택합니다.",
        mission: "임무를 감사 가능한 단계로 나누고 운용 수량을 지정합니다.",
        reliabilityRepair: "신뢰성 근거와 수리 정책을 확인하며 AI 추론값은 사람이 승인합니다.",
        calculation: "서비스 수준, 실행 모드와 누락 파라미터 정책을 설정합니다.",
        confirmation: "DRAFT 버전을 만들기 전에 차단 항목과 필드 출처를 검토합니다.",
      },
      fields: {
        ...
        stageCode: "단계 코드",
        stageName: "단계 이름",
        durationHours: "지속 시간(시간)",
        activeQuantity: "운용 수량",
        maintenanceLevel: "정비 수준",
        reliabilityProfiles: "신뢰성 프로파일",
        repairPolicy: "수리 정책",
        shockPolicy: "공통 충격 정책",
        serviceLevel: "서비스 수준",
        executionMode: "실행 모드",
        missingPolicy: "누락 파라미터 정책",
      },
      sources: {
        MASTER_DATA: "마스터 데이터",
        USER_INPUT: "사용자 입력",
      ...
      actions: {
        ...
        evidence: "개 근거",
        applyFleet: "장비군 적용",
        reloadServer: "서버 버전 다시 불러오기",
        discardLocal: "로컬 변경 취소",
        materialize: "DRAFT 버전 생성",
        materializing: "생성 중…",
      },
      conflict: {
        title: "서버 초안이 변경되었습니다",
        description: "로컬 초안은 유지됩니다. 두 버전을 비교한 뒤 다시 불러오거나 로컬 변경을 명시적으로 취소하세요.",
        local: "로컬 변경",
        server: "서버 버전",
      },
      confirmation: {
        ...
        blockingCount: "차단 필드",
        draftVersion: "초안 버전",
        aiReview: "검토 대기 중인 추론값",
        blocked: "버전 생성을 진행할 수 없습니다",
        ready: "모든 사전 검사가 완료되었습니다",
        readyHint: "편집 가능한 DRAFT만 생성합니다. 게시에는 관리자 2차 확인이 필요합니다.",
      },
      materialization: {
        draftCreated: "DRAFT 버전이 생성되었습니다",
        failed: "버전 생성 실패",
      },
      list: {
        description: "시나리오 기록, 버전 상태 및 최근 변경 사항을 확인하고 버전 상세로 이동합니다.",
        refresh: "새로 고침",
        create: "새 시나리오",
        search: "시나리오 검색",
        searchPlaceholder: "코드 또는 이름 입력",
        apply: "조회",
        includeInactive: "비활성 시나리오 포함",
        records: "개 기록",
        emptyTitle: "시나리오가 없습니다",
        emptyDescription: "첫 임무 시나리오를 만들거나 필터를 조정하세요.",
        code: "시나리오 코드",
        name: "시나리오 이름",
        category: "분류",
      ...
      detail: {
        ...
        selectVersionHint: "왼쪽 버전 등록부에서 전체 스냅샷을 엽니다. 게시된 버전은 읽기 전용입니다.",
        publishConfirmTitle: "이 버전을 게시하시겠습니까?",
        publishConfirmBody: "이 버전은 공식 계산 입력이 됩니다. 검토 완료 여부를 확인하세요.",
        publishSuccess: "버전이 게시되었습니다",
        retireConfirmTitle: "이 버전을 폐기하시겠습니까?",
        retireConfirmBody: "새 계산에는 사용되지 않으며 이전 기록은 유지됩니다.",
        retireSuccess: "버전이 폐기되었습니다",
      },
      adminPublication: {
        title: "관리자 게시",
        description: "관리자만 DRAFT를 PUBLISHED로 게시할 수 있습니다.",
      },
      empty: {
        fleetFirst: "단계 사용량을 지정하기 전에 구성과 장비군을 만드세요.",
        reliability: "사용 가능한 신뢰성 프로파일이 없습니다. 먼저 마스터 데이터를 추가하세요.",
      },
      errors: {
        masterData: "마스터 데이터를 불러오지 못했습니다. 다시 시도하세요.",
        draftLoad: "시나리오 초안을 불러오지 못했습니다.",
        materialize: "DRAFT 버전을 만들지 못했습니다.",
      },
    },
  },
  chatHeader: {
